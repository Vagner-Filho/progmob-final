...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public boolean existemUnidadesSuficientes(Pedido pedido/*, Context c, TextView t1, TextView t2,
                                              TextView t3, TextView t4, TextView t5, TextView t6,
                                              Button b1, Button b2*/) {
        ...
        for (Produto p : listaProdutos) {
            ...
            /*if (x==3) {
                t5.setText("t5  " + String.valueOf(unidade));
                t3.setText("t3  " + String.valueOf(p.getQuantidade()));
                t4.setText("t4  " + String.valueOf(p.getQuantidade() - unidade));
                t6.setText("t6  " + String.valueOf(p.getQuantidade() - unidade < 0));
            }*/
            if (p.getQuantidade() - unidade < 0) {
                /*t1.setText("t1  "+String.valueOf(p.getQuantidade() - unidade));
                b1.setText("b1  "+String.valueOf(p.getQuantidade() - unidade < 0));
                b2.setText("b1  "+String.valueOf(unidade));
                t2.setText("t2  "+String.valueOf(p.getQuantidade()));*/
                return false;
            }
        }
        return true;
